...
## Alignment
  ...
  closing bracket must be aligned with the opening tag
  eslint: [`react/jsx-closing-bracket-location`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-closing-bracket-location.md) [`react/jsx-closing-tag-location`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-closing-tag-location.md)
    ...
    // bad, closing tag should aligned with the opening tag on its own line.
...
## Quotes
  ...
  - Use double quotes (`"`) for JSX attributes  eslint: [`jsx-quotes`](https://eslint.org/docs/rules/jsx-quotes)
...
## Spacing
  ...
  - Pad JSX curly braces with 1 space before and after. eslint: [`react/jsx-curly-spacing`](https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-curly-spacing.md)
...
## Methods
  ...
  - Do not use underscore prefix for internal methods of a React component.
    This rule does not hold for javascript classes, we use undercore prefixes to indicate a method that is not intended for external use.
